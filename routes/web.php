...
Route::get('/molde-pg-balao-festa-junina', [MainController::class, 'MoldesFestaJunina'])->name('user.MoldesFestaJunina');
Route::get('/moldes-festa-junina-obrigado', [MainController::class, 'MoldesFestaJuninaObrigado'])->name('user.thanks.MoldesFestaJunina');
